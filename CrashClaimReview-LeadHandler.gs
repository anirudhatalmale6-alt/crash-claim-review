/**
 * Crash Claim Review — lead handler
 *
...
var LEAD_SECRET  = 'rMxQ7pKd2WvT9sLbE4nHc6Ja';
...
var FIELDS = [
  /* Contact first — this is what the call team needs at a glance. */
  'first_name','last_name','phone','email','state',

  /* The four screening answers from the page. */
  'injured','at_fault','within_12mo','police_report',

  /* Where the lead came from, so you can tell which ad is working. */
  'page','utm_source','utm_medium','utm_campaign','utm_content','utm_term',
...
function doGet() {
  var msg = 'Crash Claim Review lead handler is running.\n' +
